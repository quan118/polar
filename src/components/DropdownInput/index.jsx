...
const DropdownInput = ({ options, value, onChange, buttonClassName }) => (
  <Listbox value={value} onChange={onChange}>
    <div className="relative">
      <Listbox.Button
        className={clsx(
          "relative h-full cursor-default rounded-none border-none py-2 pl-2 text-left shadow-none focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 sm:text-sm",
          buttonClassName
        )}
      >
        <span className="mr-6 block truncate text-xs text-black">{value}</span>
